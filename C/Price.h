...
extern const struct Price* make_price(double, const char* currencyCode);
...
extern double get_price_amount_in_currency(const struct Price* this, const char* currencyCode);
